// Package fuzzengine implements fuzz_engine_v2.6 input derivation, coverage buckets,
...
const Version = "fuzz_engine_v2.6"
...
func MetaFromConfig(cfg map[string]any) map[string]any {
	...
	features = append(features, "stable_crash_buckets", "finding_families", "havoc_stack_v22", "interesting_be", "format_patch", "havoc_ops_v26", "havoc_stack_v26")
	...
	if CoverageFeedbackEnabled(cfg) {
		features = append(features, "coverage_feedback_v1", "hunt_structural", "power_schedule_v24", "corpus_decay", "finding_family_report", "rarity_cull")
	}
