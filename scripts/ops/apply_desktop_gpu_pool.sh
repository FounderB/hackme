...
touch "$DESKTOP_ENV"
set_kv "$DESKTOP_ENV" HACKME_WORKER_BATCH_SIZE 16777216
...
set_kv "$DESKTOP_ENV" HACKME_WORKER_CLAIM_COOLDOWN_MS 100
set_kv "$DESKTOP_ENV" HACKME_GPU_BACKEND cuda
set_kv "$DESKTOP_ENV" HACKME_DESKTOP_GPU_POOL 1
set_kv "$DESKTOP_ENV" HACKME_POOL_DIRECT 1
set_kv "$DESKTOP_ENV" HACKME_POOL_COORDINATOR_URL "http://132.243.112.100:18083"
set_kv "$DESKTOP_ENV" COORD_URL "http://132.243.112.100:18083"
