...
**Version:** `0.1.0-rc17` channel (UI) · last published artifacts `0.1.0-rc16` until SHA lands  
...
2. Include:
   ...
   - Steps to reproduce (commands, HTTP requests, version `0.1.0-rc17` / `0.1.0-rc16` artifacts or commit hash)
