...
2. Verify: `bash scripts/tests/verify_hackme_iso.sh /path/to/HackMe-OS-0.1.0-rc17-amd64.iso` (published ISO is **0.1.0-rc17** — only flash after `SHA256SUMS-iso.txt` matches)  
