...
Win/Linux channel: `scripts/release/CURRENT_VERSION` → **0.1.0-rc17**. ISO channel: `scripts/release/CURRENT_ISO_VERSION` → **0.1.0-rc17** (published artifacts still **0.1.0-rc16** until cutover SHA).
