...
- Still **deterministic** (stage+salt only) — coordinator replay unchanged for campaigns without new flags.
- Deep burst runs only when `havoc_deep_v28` is on (new Hunt campaigns already EnableDeepHavocV28).
